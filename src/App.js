 ...
 if(r==2 ){r1=0;}
  ...
  return (
   ...
   flexdirection:'row-reverse'
     ...
     <a href="https://react-gusdqt.stackblitz.io"  style={{ backgroundColor:'white',
  ...
  <div style={{fontWeight:'bold',fontSize:"25px"}}>Add New Internship</div>
   <a href="https://react-z5hwbb.stackblitz.io" style={{height:'25px',
...
style={{width:'100%',height:'55px',justifyContent:'space-between',
   ...
   }}><div style={{display:'flex'}}><div>Survey 1</div></div><div style={{color:'gray'}}><MdPlayArrow/></div></button></div></div>
</div>
...
style={{width:'100%',height:'55px',justifyContent:'space-between',
   ...
   }}><div style={{display:'flex'}}><div>Survey 2</div></div><div style={{color:'gray'}}><MdPlayArrow/></div></button></div></div>
</div>
